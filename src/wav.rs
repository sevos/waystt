...
mod tests {
    ...
    fn test_wav_header_generation_stereo_44khz() {
        ...
        // Check sample rate
        assert_eq!(u32::from_le_bytes([header[24], header[25], header[26], header[27]]), 44100);
    }
    ...
    fn test_whisper_optimized_format() {
        ...
        assert_eq!(u32::from_le_bytes([header[24], header[25], header[26], header[27]]), 16000); // 16kHz

...
impl fmt::Display for TranscriptionError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            TranscriptionError::ConfigurationError(msg) => write!(f, "Configuration error: {}", msg),
        ...
        match provider_type.to_lowercase().as_str() {
            "openai" => {
                ...
                let api_key = config.openai_api_key
                    .ok_or_else(|| TranscriptionError::ConfigurationError("OpenAI API key not found".to_string()))?;
            ...
            _ => Err(TranscriptionError::UnsupportedProvider(provider_type.to_string())),
        }
    }
}
